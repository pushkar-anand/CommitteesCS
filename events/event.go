...
type Event struct {
	...
	StartDate 			*string `gorm:"start_date" schema:"start_date,required" validate:"required,trim,printascii"`
	EndDate     		*string `gorm:"end_date" schema:"end_date,required" validate:"required,trim,printascii"`
